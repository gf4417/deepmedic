...
class TrainSessionParameters(object):
    ...
    def __init__(self,
        ...
        self.losses_and_weights = cfg[cfg.LOSSES_WEIGHTS] if cfg[cfg.LOSSES_WEIGHTS] is not None else {"xentr": 1.0,
                                                                                                       ...
                                                                                                       "m_teach_c": None,
                                                                                                       "m_teach_ce": None,
                                                                                                       "m_teach_c_logits": None}
        assert True in [self.losses_and_weights[k] is not None for k in ["xentr", "iou", "dsc", "ace", "ace_w", "m_teach", "m_teach_ace", "m_teach_a", "m_teach_c", "m_teach_ce", "m_teach_c_logits"]]
